    ...
    try {
        ...
        switch(action) {
            case 'cleanup':
                ...
                const config = JSON.parse(masterData.files['csci3213-config.json'].content);
            ...
            case 'createGist':
                ...
                response = await fetch(API_BASE, {
                    ...
                    body: JSON.stringify({
                        description: `CSCI 3213 - Student Data: ${studentId}`,
                        public: true,
                        files: {
                            'student-data.json': {
                                content: JSON.stringify(updateData, null, 2)
                ...
                if (masterGistId) {
                    try {
                        ...
                        if (masterResponse.ok) {
                            ...
                            const configContent = masterGist.files['csci3213-config.json'].content;
